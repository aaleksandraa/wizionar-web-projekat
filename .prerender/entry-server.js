...
const getBncShopArticle = (lang) => sections.map((section) => {
  var _a2;
  return {
    heading: (_a2 = section.heading) == null ? void 0 : _a2[lang],
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "pb-12 pt-28", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-6", children: [
      ...
      /* @__PURE__ */ jsxs(motion.div, { ...fadeUp$2, children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "w-full text-lg leading-relaxed text-muted-foreground", children: project.description[lang] }),
