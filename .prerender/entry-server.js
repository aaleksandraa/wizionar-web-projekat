      ...
      motion.header,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto flex items-center justify-between px-6 py-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden items-center gap-3 md:flex", children: [
            ...
            /* @__PURE__ */ jsx(Button, { size: "default", className: "rounded-full shadow-orange gap-1.5", asChild: true, children: isHomePage ? /* @__PURE__ */ jsxs("a", { href: "#contact", children: [
              t.nav.requestDemo,
              /* @__PURE__ */ jsx(ArrowUpRight, { className: "w-4 h-4" })
            ] }) : /* @__PURE__ */ jsxs(LocalizedLink, { to: "/#contact", children: [
              t.nav.requestDemo,
              /* @__PURE__ */ jsx(ArrowUpRight, { className: "w-4 h-4" })
            ] }) })
          ] }),
        ...
        motion.aside,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "border-t border-border/60 bg-background px-5 py-5", children: [
              ...
              /* @__PURE__ */ jsx(Button, { asChild: true, size: "lg", className: "w-full rounded-xl shadow-orange gap-1.5", children: isHomePage ? /* @__PURE__ */ jsxs("a", { href: "#contact", onClick: closeMobileMenu, children: [
                t.nav.requestDemo,
                /* @__PURE__ */ jsx(ArrowUpRight, { className: "w-4 h-4" })
              ] }) : /* @__PURE__ */ jsxs(LocalizedLink, { to: "/#contact", onClick: closeMobileMenu, children: [
                t.nav.requestDemo,
                /* @__PURE__ */ jsx(ArrowUpRight, { className: "w-4 h-4" })
              ] }) })
            ] })
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-secondary/30 py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-6", children: /* @__PURE__ */ jsxs(motion.div, { ...fadeUp$2, className: "mx-auto max-w-3xl text-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-6 flex flex-col justify-center gap-4 sm:flex-row", children: [
          /* @__PURE__ */ jsxs(
            "a",
            {
              href: "mailto:info@wizionar.com",
...
const buildHeadHtml = (urlPath) => {
  ...
  const ogImage = "".concat(BASE_URL, "/favicon.ico");
